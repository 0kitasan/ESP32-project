...
const char *ssid = "esp32_sjtu";     // WiFi SSID
const char *password = "esp32_sjtu"; // WiFi 密码

const char *serverName = "http://192.168.137.1:8000/sensor/"; // 服务器地址
...
void loop() {
  if ((millis() - lastTime) > timerDelay) { // 达到发送间隔
    ...
    if (WiFi.status() == WL_CONNECTED) {
      ...
      // int httpResponseCode = http.POST("{\"name\":\"sensor\",\"value\":123.0}");
